function generate_seats() {
  ...
  seats.push({ area: "M", row: 4, col: 0, sold: 0 });
  for (let j = 0; j < 6; j++) seats.push({ area: "X", row: 4, col: j, sold: 0 });
  seats.push({ area: "M", row: 4, col: 0, sold: 0 });
  for (let j = 8; j <= 10; j += 2) seats.push({ area: "S", row: 4, col: j, sold: 0 });
  for (let j = 12; j <= 28; j += 2) seats.push({ area: "X", row: 4, col: j, sold: 0 });

  //row 5
  for (let j = 31; j >= 17; j -= 2) seats.push({ area: "X", row: 5, col: j, sold: 0 });
  ...
  seats.push({ area: "M", row: 5, col: 0, sold: 0 });
  for (let j = 0; j < 5; j++) seats.push({ area: "X", row: 5, col: j, sold: 0 });
  seats.push({ area: "M", row: 5, col: 0, sold: 0 });
  for (let j = 10; j <= 14; j += 2) seats.push({ area: "S", row: 5, col: j, sold: 0 });
  for (let j = 16; j <= 30; j += 2) seats.push({ area: "X", row: 5, col: j, sold: 0 });

  //row 6
  for (let j = 31; j >= 15; j -= 2) seats.push({ area: "X", row: 6, col: j, sold: 0 });
  for (let j = 13; j >= 11; j -= 2) seats.push({ area: "S", row: 6, col: j, sold: 0 });
  seats.push({ area: "M", row: 6, col: 0, sold: 0 });
  for (let j = 0; j < 20; j++) seats.push({ area: "X", row: 6, col: j, sold: 0 });
  seats.push({ area: "M", row: 6, col: 0, sold: 0 });
  for (let j = 10; j <= 12; j += 2) seats.push({ area: "S", row: 6, col: j, sold: 0 });
  for (let j = 14; j <= 30; j += 2) seats.push({ area: "X", row: 6, col: j, sold: 0 });
